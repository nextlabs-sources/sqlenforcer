...
class PolicyHelper {
public:
    static bool DownloadPolicys(const std::string& service, const std::string& port, const std::string& user, const std::string& pwd, const std::string& model_name, const std::string& tag,
...
//                                   std::map<CID, std::vector<Json::Value *>> &component_patch_list, std::map<AID, std::vector<Json::Value *>> &action_patch_list);
    ...
    static bool PolicyPatchAction(std::vector<Json::Value>& policy_roots, std::map<AID, std::vector<Json::Value *>> &action_patch_list);
    static bool PolicyPatchResAndSub(std::vector<Json::Value>& policy_roots, std::map<AID, std::vector<Json::Value *>> &component_patch_list);
