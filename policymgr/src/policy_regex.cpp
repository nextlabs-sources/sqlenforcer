...
//const std::regex MATCHED_ZERO_OR_MORE_CHARACTERS_NOT_INCLUDING_THE_PATH_SEPARATOR("[^/]*"); this will cause crash on PowerPC
...
#if 0   // not all control paths return a value
