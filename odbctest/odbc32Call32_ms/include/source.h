...
typedef SQLRETURN(SQL_API *SQLFetchScrollFun)(SQLHSTMT StatementHandle, SQLSMALLINT FetchOrientation, SQLLEN FetchOffset);
...
typedef SQLRETURN(SQL_API *SQLSetStmtOptionFun)(SQLHSTMT StatementHandle, SQLUSMALLINT Option, SQLULEN Value);
...
typedef SQLRETURN(SQL_API *SQLAllocHandleStdFun)(SQLSMALLINT fHandleType, SQLHANDLE hInput, SQLHANDLE * phOutput);

/*typedef SQLRETURN(SQL_API *CloseODBCPerfDataFun);
typedef SQLRETURN(SQL_API *CollectODBCPerfDataFun);
typedef SQLRETURN(SQL_API *CursorLibLockDbcFun);
typedef SQLRETURN(SQL_API *CursorLibLockDescFun);
typedef SQLRETURN(SQL_API *CursorLibLockStmtFun);
typedef SQLRETURN(SQL_API *CursorLibTransactFun);
typedef SQLRETURN(SQL_API *DllBidEntryPointFun);
typedef SQLRETURN(SQL_API *GetODBCSharedDataFun);
typedef SQLRETURN(SQL_API *LockHandleFun);
typedef SQLRETURN(SQL_API *ODBCGetTryWaitValueFun);
typedef SQLRETURN(SQL_API ODBCInternalConnectWFun);
typedef SQLRETURN(SQL_API *ODBCQualifyFileDSNWFun);
typedef SQLRETURN(SQL_API *ODBCSetTryWaitValueFun);
typedef SQLRETURN(SQL_API *OpenODBCPerfDataFun);
typedef SQLRETURN(SQL_API *PostComponentErrorFun);
typedef SQLRETURN(SQL_API *PostODBCComponentErrorFun);
typedef SQLRETURN(SQL_API *PostODBCErrorFun);
...
typedef SQLRETURN(SQL_API *SearchStatusCodeFun);
typedef SQLRETURN(SQL_API *VFreeErrorsFun);
typedef SQLRETURN(SQL_API *VRetrieveDriverErrorsRowColFun);
typedef SQLRETURN(SQL_API *ValidateErrorQueueFun);
typedef SQLRETURN(SQL_API *g_hHeapMallocFun);*/
...
public:
	...
	bool LoadEnforcer(bool isEnforcered);
...
public:
	...
	/*CloseODBCPerfDataFun CloseODBCPerfData;
	CollectODBCPerfDataFun CollectODBCPerfData;
	CursorLibLockDbcFun CursorLibLockDbc;
	CursorLibLockDescFun CursorLibLockDesc;
	CursorLibLockStmtFun CursorLibLockStmt;
	CursorLibTransactFun CursorLibTransact;
	DllBidEntryPointFun DllBidEntryPoint;
	GetODBCSharedDataFun GetODBCSharedData;
	LockHandleFun LockHandle;
	ODBCGetTryWaitValueFun ODBCGetTryWaitValue;
	ODBCInternalConnectWFun ODBCInternalConnectW;
	ODBCQualifyFileDSNWFun ODBCQualifyFileDSNW;
	ODBCSetTryWaitValueFun ODBCSetTryWaitValue;
	OpenODBCPerfDataFun OpenODBCPerfData;
	PostComponentErrorFun PostComponentError;
	PostODBCComponentErrorFun PostODBCComponentError;
	PostODBCErrorFun PostODBCError;
	SQLGetConnectOptionFun SQLGetConnectOption;
	SQLSetDescFieldAFun SQLSetDescFieldA;
	SQLSetStmtAttrAFun SQLSetStmtAttrA;
	SearchStatusCodeFun SearchStatusCode;
	VFreeErrorsFun VFreeErrors;
	VRetrieveDriverErrorsRowColFun VRetrieveDriverErrorsRowCol;
	ValidateErrorQueueFun ValidateErrorQueue;
	g_hHeapMallocFun g_hHeapMalloc;*/
protected:
	Enforcer();
