...
inline ServiceString ServiceStatusToString(ServiceStatus const status)
{
   switch (status)
   {
...
inline ServiceString ServiceTypeToString(ServiceType const type)
{
   switch (type)
   {
...
inline ServiceString ServiceStartTypeToString(ServiceStartType const type)
{
   switch (type)
   {
...
inline ServiceString ServiceErrorControlToString(ServiceErrorControl const control)
{
   switch (control)
   {
