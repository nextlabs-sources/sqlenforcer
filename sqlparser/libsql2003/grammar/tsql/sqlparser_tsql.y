...
%output  "sqlparser_tsql_bison.cpp"
%defines "sqlparser_tsql_bison.h"

// Tell bison to create a reentrant parser
%define api.pure full

// Prefix the parser
%define api.prefix {tsql_}
%define api.token.prefix {TSQL_}
    ...
    expr
{
    ...
    {
        tsql_error(&@1, result, scanner, "update element format error");
    	YYABORT;
    }
