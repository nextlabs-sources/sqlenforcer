...
public class nxlConnection implements  Connection {
    ...
    private boolean initEnforceContext (Properties info) throws SQLException {
        ...
        EMDB_DB_TYPE dbtype = EMDB_DB_TYPE.DB_HANA;
        if(serverName == null || userName == null || dataBaseName == null|| schema == null)
        {
            ...
            if (!ss.isEmpty()){
                serverName = "";
                String str = ss.substring(ss.lastIndexOf("//")+2);
                for(int i=0;i < str.length();i++) {
                    char c = str.charAt(i);
                    if(c == '.' || Character.isDigit(c) ){
                        serverName += str.charAt(i);
                    } else{
                        break;
                    }
                }
        ...
        {
            nxlEnforcer.SQLEnforcerWriteLog(3, "get resource attr failed!");
            return false;
        }
    ...
    private static String getRealDriverPath(String url){
        ...
        try {
            ...
            nxlEnforcer.SQLEnforcerWriteLog(4,"[JDBC.hana_path] is incorrect in config.ini. "+ e.getMessage());
            //e.printStackTrace();
        }
        return "";
    }
    ...
    public static Connection createRealConnection (String var1, Properties var2, String keyword) throws SQLException {
        ...
        nxlEnforcer.SQLEnforcerWriteLog(1, "load real driver [hana_path]="+path);
    ...
    nxlConnection(String var1, Properties var2) throws SQLException {
        ...
        //-----get connection
        this.connection = nxlConnection.createRealConnection(real_url,var2,"sap");
