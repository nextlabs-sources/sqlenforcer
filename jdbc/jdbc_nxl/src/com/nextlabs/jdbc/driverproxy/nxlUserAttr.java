    ...
    public void run() {        
        try{
            ...
            try {
                ...
                nxlEnforcer.SQLEnforcerWriteLog(3,"nxlUserAttr.run USERMODE.sync_time is error. " );
            }
           ...
           String tb = table.substring(0, idot);
            ...
            while(!b){
				b = this.exit;
				sleep(iref);
                Connection con = DriverManager.getConnection(this.url,this._con_attr );
            ...
            //nxlEnforcer.SQLEnforcerWriteLog(3,"----nxlUserAttr.run Exception " +  e.getMessage() );
        } catch (Exception exc) {
