...
public class nxlConnection implements  Connection {
    ...
    static  final String SQL_QUERY_DBINFO_SQLSERVER = "SELECT SUSER_SNAME(),'schema',DB_NAME(),@@SERVERNAME;";
    ...
    static  final String SQL_QUERY_DBINFO_HANA = "SELECT CURRENT_USER,CURRENT_SCHEMA AS SCHEMA_NAME,(SELECT DATABASE_NAME FROM SYS.M_DATABASES) AS DB_NAME, '' AS SERVER_NAME FROM DUMMY";
    ...
    private boolean initEnforceContext (Properties info) throws SQLException {
        ...
        EMDB_DB_TYPE dbtype = EMDB_DB_TYPE.DB_ORACLE;
    ...
    private static String getRealDriverPath(String url){
        ...
        try {
            ...
            nxlEnforcer.SQLEnforcerWriteLog(4,"[JDBC.oracle_path] is incorrect in config.ini. "+ e.getMessage());
        }
        return "";
    }
    ...
    public static Connection createRealConnection (String var1, Properties var2, String keyword) throws SQLException {
        ...
        nxlEnforcer.SQLEnforcerWriteLog(1,  "load real driver [oracle_path]="+path);

        //ojdbc_path = "C:/Program Files/Tableau/driver/ojdbc8.jar";
        ...
        try{
            ...
            while(driversIterator.hasNext()) {
                ...
                nxlEnforcer.SQLEnforcerWriteLog(1,  "load real driver name:"+sname);
    ...
    nxlConnection(String var1, Properties var2) throws SQLException {
        ...
        this.connection = nxlConnection.createRealConnection(real_url,var2,"OracleDriver");
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        nxlPreparedStatement preparedStatement = new nxlPreparedStatement(this.connection, enforcerContext, sql);
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        ...
        //nxlEnforcedSqlResult enforcedSqlResult = nxlEnforcer.SQLEnforcerEvaluation(enforcerContext, sql);
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        PreparedStatement preparedStatement = new nxlPreparedStatement(this.connection, enforcerContext, sql,resultSetType,resultSetConcurrency);
        return preparedStatement;
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        PreparedStatement preparedStatement = new nxlPreparedStatement(this.connection, enforcerContext, sql,resultSetType,resultSetConcurrency,resultSetHoldability);
        return preparedStatement;
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        PreparedStatement preparedStatement = new nxlPreparedStatement(this.connection, enforcerContext, sql,autoGeneratedKeys);
        return preparedStatement;
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        PreparedStatement preparedStatement = new nxlPreparedStatement(this.connection, enforcerContext, sql,columnIndexes);
        return preparedStatement;
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        PreparedStatement preparedStatement = new nxlPreparedStatement(this.connection, enforcerContext, sql,columnNames);
        return preparedStatement;
    }
